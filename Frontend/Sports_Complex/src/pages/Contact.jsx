...
const Contact = () => {
  ...
  const contactInfo = [
    ...
    {
      icon: <FaPhoneAlt size={20} className="text-blue-500" />,
      title: "Phone",
    ...
    {
      icon: <FaClock size={20} className="text-blue-500" />,
      title: "Hours",
      content: "Monday - Sunday: 6:00 AM - 10:00 PM"
    }
  ];
    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        <section className="relative h-64 bg-gray-900 overflow-hidden">
          ...
          <img 
            src="https://images.unsplash.com/photo-1483721310020-03333e577078?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1920&q=80" 
            alt="Contact Us" 
                ...
                <div className="md:w-2/3">
                  <div className="flex border-b border-gray-200 mb-6">
                    ...
                    <button
                      ...
                      className={`px-4 py-2 font-medium ${activeTab === 'map' ? 'text-blue-600 border-b-2 border-blue-600' : 'text-gray-500 hover:text-gray-700'}`}
                    >
                      Find Us
                    </button>
                  </div>
                  ...
                  {activeTab === 'form' ? (
                    ...
                    >
                      <iframe
                        ...
                        marginHeight="0"
                        marginWidth="0"
                        src="https://maps.google.com/maps?width=100%25&amp;height=500&amp;hl=en&amp;q=123%20Sports%20Avenue,%20Athletic%20City+(SportZone)&amp;t=&amp;z=14&amp;ie=UTF8&amp;iwloc=B&amp;output=embed"
                      >
                      </iframe>
                    </motion.div>
                  )}
